            ...
            <div className="content-home">
                ...
                <div className='content-banner'>
                    ...
                    <div className='flex mt-6'>
                        <form>
                            <input className='p-5 px-8 text-xs rounded-l-md border border-r-0' placeholder="chosse" />
                            <input className='p-5 px-8 text-xs border border-r-0' placeholder="chosse" />
            ...
            <div className='fw-bread'>
                <Row className='ml-32 py-5 items-center font-medium text-xs conten-fw'>
                    ...
                    <Col span={8} offset={8} className='flex justify-end'>
                        <button className='share-btn'><ShareAltOutlined className='mr-3 mt-1 text-blue-500' />Share</button>
                    </Col>
                </Row>
            </div>
        </div>
